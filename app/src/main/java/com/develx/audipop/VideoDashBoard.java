...
public class VideoDashBoard extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()){
                    case R.id.folderList:
                        Toast.makeText(VideoDashBoard.this, "Folders selected", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case R.id.filesList:
                        Toast.makeText(VideoDashBoard.this, "Files selected", Toast.LENGTH_SHORT).show();
    ...
    private void permission() {
        if(ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(VideoDashBoard.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CODE_PERMISSION);
